...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full py-6 px-10 md:px-14 flex justify-between items-center z-50 bg-light shadow-md md:bg-transparent md:shadow-none">
      <div
